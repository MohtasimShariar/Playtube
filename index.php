  ...
  <body>
    ...
    <div class="container">
      ...
      <header class="blog-header py-3">
        <div class="row flex-nowrap justify-content-between align-items-center">
         ...
         <div class="input-group sm-3">
          ...
          <div class="input-group-append">
          <button><a href="admin_login.php" class="btn btn-info" role="button">Admin Login</a></button>
          </div>
        </div>
     ...
     <div class="card" style="width:100%; height:350px;" >
      ...
      <h4 class="card-title">Unique Newspaper</h4>
        <p class="card-text">Unique Newspaper publish real news</p>
    ...
    include('db/connection.php');
     $query1 =mysqli_query($conn,"select * from product order by id desc limit 1,2 ");
        ...
        <div class="col-md-6">
          <div class="card flex-md-row mb-4 box-shadow h-md-250">
            ...
            <div class="card-body d-flex flex-column align-items-start">
              <strong class="d-inline-block mb-2 text-primary"><?php echo $playlist ; ?></strong>
              <h3 class="mb-0">
            ...
            <img class="card-img-right flex-auto d-none d-md-block" src="images/<?php echo $image;?>" alt="Card image cap" width="150">
          </div>
        </div>
      <?php } ?>
    ...
    <main role="main" class="container">
      <div class="row">
       ...
       include('db/connection.php');
        ...
        $query=mysqli_query($conn,"select * from product limit $page1,5 ");
         while($row=mysqli_fetch_array($query)){
          ...
          <div class="blog-post">
            ...
            <p><img class="img img-image"  src="images/<?php echo $row['image'];?>"  width="400" height="200" > </p>
            <hr>
          ...
          <div class="p-3 mb-3 bg-light rounded">
           ...
           <div class="p-3">
            ...
            <ol class="list-unstyled mb-0">
               <?php
               include('db/connection.php');
                $query1=mysqli_query($conn,"select * from playlist");
                while($row=mysqli_fetch_array($query1)){

                

               ?>
              <li><a href="playlist_page.php?single=<?php echo$row['playlist_name'];  ?>"><?php echo $row['playlist_name']; ?></a></li>
              <?php } ?>
            </ol>
          </div>
    ...
    <footer class="blog-footer">
      <p>Unique Newspaper by <a href="">U</a>.</p>
      <p>
