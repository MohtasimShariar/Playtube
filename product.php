 ...
 <div style="margin-left:16%;  width: 90%;">
  ...
  <div style=" width: 70%; margin-left: 20%; margin-top: 5%">
    ...
    <table class="table table-bordered">
      ...
      $query=mysqli_query($conn,"select * from product limit $page1,3");
             ...
             <td><?php echo substr($row['description'],0,100 ); ?></td>
               <td><?php echo date("F jS ,y", strtotime($row['date'])); ?></td>
                 <td><?php echo $row['playlist']; ?></td>
                   <td><img class="img img-image" src="images/<?php echo $row['image'];?>" alt="" width="150" height="150" ></td>
                   <td><?php echo $row['admin'];?></td>
                   <td><a class="btn btn-info btn-sm" href="product_edit.php?edit=<?php echo $row['id'];?>">edit</a></td>
                     <td><a class="btn btn-danger btn-sm" href="product_delete.php?del=<?php echo $row['id'];?>">delete</a></td>
