...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="nav-scroller py-1 mb-2">
        <nav class="nav d-flex justify-content-between">
          ...
          <a class="p-2 text-muted" href="playlist_page.php?single=<?php echo$row['playlist_name'];  ?>">Technology</a>
   ...
   $id=$_GET['single'];
      ...
      $query1=mysqli_query($conn,"select * from news where playlist='$id' ");
   ...
   <?php } ?>
    ...
    <footer class="blog-footer">
      <p>Unique Newspaper by <a href="">Ummey Khadiza</a>.</p>
      <p>
